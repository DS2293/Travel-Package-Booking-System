package com.tpbs.userservice.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (userRole != null && userEmail != null && userId != null) {
            log.debug("Processing request for user: {} with role: {}", userEmail, userRole);
            ...
            log.debug("User {} authenticated with role: {}", userEmail, userRole);
        }
